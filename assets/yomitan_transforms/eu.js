(() => {
  ...
  // third_party/yomitan/ext/js/language/eu/basque-transforms.js
  var conditions = {
    n: {
      name: "Noun",
  ...
  // third_party/yomitan/ext/js/language/transform-entries/eu.js
  globalThis.mangatanRegisterYomitanTransforms("eu", basqueTransforms);
})();
