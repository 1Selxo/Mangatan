...
class HoshiGlossaryEntry {
  ...
  @override
  int get hashCode => dictName.hashCode ^ glossary.hashCode ^ definitionTags.hashCode ^ termTags.hashCode;
...
class HoshiLookupResult {
  ...
  @override
  int get hashCode =>
      matched.hashCode ^ deinflected.hashCode ^ trace.hashCode ^ preprocessorSteps.hashCode ^ term.hashCode;
...
class HoshiPitchEntry {
  ...
  const HoshiPitchEntry({required this.dictName, required this.pitchPositions, required this.transcriptions});

  @override
  int get hashCode => dictName.hashCode ^ pitchPositions.hashCode ^ transcriptions.hashCode;
