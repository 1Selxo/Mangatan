...
/// Fork-local chapters store an absolute archive path, so no virtual-folder
/// translation is needed when opening them.
Future<String> resolveLocalArchivePath(String archivePath) async => archivePath;
