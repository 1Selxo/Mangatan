...
Future<HoshiLookupSession> createLookupSession() => RustLib.instance.api.crateApiHoshidictsNativeCreateLookupSession();
...
Future<List<HoshiDictionaryStyle>> getStyles({required HoshiLookupSession session}) =>
